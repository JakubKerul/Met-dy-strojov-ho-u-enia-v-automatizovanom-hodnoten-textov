...
Skóre:"""
    ...
    try:
        ...
        print("   [DEBUG] Ziadne cislo 0-3, fallback 1.5")
        return 1.5
...
plt.ylabel('Predikované skore (GPT-OSS)')
plt.title('GPT-OSS-120B few-shot vs. ľudské hodnotenie')
plt.legend()
plt.savefig('grafy/gptoss_vysledky.png')
plt.show()