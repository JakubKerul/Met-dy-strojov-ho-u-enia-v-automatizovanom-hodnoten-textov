...
client = anthropic.Anthropic(api_key="SEM_VLOZ_SVOJ_API_KLUC")
...
plt.ylabel('Predikované skore (Claude)')
plt.title('Claude few-shot vs. ľudské hodnotenie')
plt.legend()
plt.savefig('grafy/claude_vysledky.png')
plt.show()